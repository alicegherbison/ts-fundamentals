 ...
 */
// you can have 3 slots on a symbol - value, type and namespace, and each file is associated with one
// iterates over each file and asks the checker for the symbol at the location of the file - using the language server
...
sfSymbols.forEach(sfSymbol => {
  ...
  console.log(sfSymbol.name); // name will be the path of that file
  if (fileExports) {
